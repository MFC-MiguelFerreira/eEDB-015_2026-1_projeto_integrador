...
| `silver_exploration.ipynb` | *(exploração — sem job correspondente)* | Explora as tabelas da camada Silver: schema tipado, amostra, perfil de nulos, estatísticas e notas para desenvolvimento da Gold |
